    ...
    <div className="prizes-page">
      ...
      <main>
        <section className="prizes">
          ...
          <img src={placeholderImage} alt="Top 3 Winners" />
          <h2>$2500 for best speaker</h2>
          <img src={placeholderImage} alt="Best Speaker" />
          <h2>$1500 for most inspirational</h2>
          <img src={placeholderImage} alt="Most Inspirational" />
          <h2>$1000 for best persuasive speech</h2>
          <img src={placeholderImage} alt="Best Persuasive Speech" />
        </section>
      </main>
      <footer>
